...
def compute_matching_homographies(e2: np.array, F: np.array, im2: np.array, points1: np.array,
...
if __name__ == '__main__':
    ...
    aligned_img = show_epipolar_imgs(rectified_im1, rectified_im2, lines1, lines2, new_points1, new_points2,
                                     offset=int(total_offset_y))
